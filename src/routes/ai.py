...
def chat():
    try:
        ...
        if len(context) > 10:
            # Сбрасываем контекст, сохраняя только системное сообщение и последнее сообщение пользователя
            context = [
                {'role': 'assistant', 'content': 'Контекст был сброшен из-за превышения лимита в 10 сообщений. Начинаем новый разговор.'},
